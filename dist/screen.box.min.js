(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.screenData = factory(global.Vue));
  ...
  var script = /*#__PURE__*/Object.assign(__default__, {
    ...
    setup: function setup(__props, _ref) {
      ...
      var vueScreenBoxRef = vue.ref(null);
      var observer = vue.ref(null);
      var ready = vue.ref(false);
      vue.onMounted( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      var updateSize = function updateSize() {
        if (width.value && height.value) {
          vueScreenBoxRef.value.style.width = "".concat(width.value, "px");
          vueScreenBoxRef.value.style.height = "".concat(height.value, "px");
        }
      };
      ...
      var updateScale = function updateScale() {
        ...
        vueScreenBoxRef.value.style.transform = "scale(".concat(widthScale, ",").concat(heightScale, ")");
      };
      ...
      return function (_ctx, _cache) {
        return vue.openBlock(), vue.createElementBlock("div", {
          id: "vue-screen-box-container",
          ref_key: "vueScreenBoxRef",
          ref: vueScreenBoxRef
        }, [ready.value ? vue.renderSlot(_ctx.$slots, "default", {
          key: 0
        }) : vue.createCommentVNode("v-if", true)], 512 /* NEED_PATCH */);
      };
    }
  });
  ...
  var css_248z = "#vue-screen-box-container[data-v-f3ef6b12] {\n  position: fixed;\n  top: 0;\n  left: 0;\n  overflow: hidden;\n  z-index: 999;\n  transform-origin: left top;\n}\n#vue-screen-box-container[data-v-f3ef6b12] .button[data-v-f3ef6b12] {\n  font-size: 140px;\n}";
  styleInject(css_248z);

  script.__scopeId = "data-v-f3ef6b12";
  script.__file = "src/component/index.vue";

  script.install = function (Vue) {
    return Vue.component(script.name, script);
  };
